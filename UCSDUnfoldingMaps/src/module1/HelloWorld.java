...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		map1 = new UnfoldingMap(this, 20, 20, 370, 560, provider);
		...
		map2 = new UnfoldingMap(this, 410, 20, 370, 560, provider);
		map2.zoomAndPanTo(zoomLevel, new Location(49.61f,6.08f));
